  ...
  useEffect(() => {
    const getMediaFiles = () => {
      try {
        ...
        const videoFiles = [
          { filename: '03d49d6f-fff9-418f-80ad-ea99e5b7c9c2.MP4', title: 'Pre-season - creativity' },
          { filename: '13923eba-9213-4f59-89ef-5faf7ebb9f4e.MP4', title: 'photo shot - U20 camp' },
          { filename: '1f22a2a7-3580-4d70-802a-c89c523b68d2.MP4', title: 'Skill Development - goal scoring ability' },
          { filename: '2b31e957-8b7a-43fa-9a63-dd1c6ec5be82.MP4', title: 'in action - katsina united' },
          { filename: '3df39ee9-f359-4915-8637-6b77650f39ea.MP4', title: 'Pre-Season Fitness Training' },
          { filename: '3f7954d3-e250-40a3-b9f1-57ff505a0dc8.MP4', title: 'dribbling skills' },
          { filename: '4dde7a11-aefc-4daf-b35c-2645d432e278.MP4', title: 'control & Passing skills' },
          { filename: '55a453c9-69f2-414a-9ff8-637164020977.MP4', title: 'Match Day Preparation' },
          { filename: '597ee271-03cd-4b62-9227-8d08681b57e0.MP4', title: 'tournament-poland' },
          { filename: '62c35b59-7ddd-44f7-946a-5c8805229129.MP4', title: 'Team Building Exercise' },
          { filename: '7673194a-fbf2-4eb5-a45e-c3eccb80d252.MP4', title: 'heading to camp' },
          { filename: '7edc7673-02ea-4f3b-91a5-727cd68353f6.MP4', title: 'speed and agility' },
          { filename: '8da75429-295a-49db-a4f5-a717b860742b.MP4', title: 'Youth Academy Training' },
          { filename: '9d2f2809-dcb3-4aa8-8c51-a1eeb56b71fb.MP4', title: 'Katsina-united' },
          { filename: 'a256fbf4-d110-4eab-b306-5e3b89c6ef64.MP4', title: 'Tournament-norway/poland' },
          { filename: 'cd6836f0-84f7-4d92-9555-cff8e63fe9cd.MP4', title: 'home-flexing' },
          { filename: 'dac46d81-207d-4ab5-b46d-163b1ff0847d.MP4', title: 'enroute to camp' },
          { filename: 'ee052b28-00d3-4427-ac49-66ccfb828ef2.MP4', title: 'dribbling skills' },
          { filename: 'f0eb7c66-7612-43c3-ab55-802b3a0ccc5e.MP4', title: 'championship match' },
